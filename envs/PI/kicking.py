...
class Kicking(BaseTask):
    ...
    def _create_envs(self):
        ...
        self.ball_radius = self.cfg["ball"].get("radius", 0.05)
    ...
    def _reward_body_alignment_for_kick(self):
        ...
        kick_target_pos_world = self.cfg["rewards"].get("kick_target_pos_world", [5.0, 0.0, self.ball_radius])
        if len(kick_target_pos_world) == 2:
            kick_target_pos_world = [kick_target_pos_world[0], kick_target_pos_world[1], self.ball_radius]
        kick_target_pos_world = to_torch(kick_target_pos_world, device=self.device).unsqueeze(0)
